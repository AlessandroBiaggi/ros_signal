...
namespace ros_signal {
    ...
    public:
        using typename SignalMonitorBase<MsgT, AllocT>::message_type;
    ...
    private:
        using SignalMonitorBase<MsgT>::errors_;
    ...
    SignalMonitor<MsgT, AllocT>::SignalMonitor(
        ...
        static_assert((std::is_invocable_r_v<bool, std::decay_t<CheckTs>, const message_type &> && ...),
