...
namespace ros_signal {
    ...
    public:
        ...
        using message_type = typename SignalMonitorBase<MsgT, AllocT>::message_type;
        ...
        void signal(const rclcpp::Time &stamp, const message_type &msg);
    ...
    template<typename MsgT, typename AllocT>
    void TopicMonitor<MsgT, AllocT>::signal(const rclcpp::Time &stamp, const message_type &msg) {
